...
public class ResourceAccessCheck extends AbstractEntry {
    ...
    public void run(ProcedureRunner runner) throws Exception {
        ...
        if(IResourceAccessChecker.RESULT_UNREGISTERED.equalsIgnoreCase(result)) {
            logger.log(Level.SEVERE, "{0} is {1} or resourceCache initialise failed, please check the log.", new Object[]{service_name, result});
            throw new RuntimeException(service_name + ": is unregistered or resourceCache initialise failed, please check the log.");
        }
