...
var arrayMin = Charts.arrayMin,
	arrayMax = Charts.arrayMax,
	each = Charts.each,
	extend = Charts.extend,
	merge = Charts.merge,
	map = Charts.map,
	pick = Charts.pick,
	pInt = Charts.pInt,
	defaultPlotOptions = Charts.getOptions().plotOptions,
	seriesTypes = Charts.seriesTypes,
	extendClass = Charts.extendClass,
	splat = Charts.splat,
	wrap = Charts.wrap,
	Axis = Charts.Axis,
	Tick = Charts.Tick,
	Point = Charts.Point,
	Pointer = Charts.Pointer,
	TrackerMixin = Charts.TrackerMixin,
	CenteredSeriesMixin = Charts.CenteredSeriesMixin,
 ...
 * 
 * In the future, this can be extended to basic Charts and Highstock.
 */
...
var radialAxisMixin = {
	...
	setAxisSize: function () {
		...
		if (this.isRadial) {
			...
			// Set the center array
			this.center = this.pane.center = Charts.CenteredSeriesMixin.getCenter.call(this.pane);
...
seriesTypes.arearange = extendClass(seriesTypes.area, {
	...
	getSegmentPath: function (segment) {
		...
		lowSegment = ChartsAdapter.grep(segment, function (point) {
...
seriesTypes.waterfall = extendClass(seriesTypes.column, {
	...
	getAttribs: function () {
		...
		var series = this,
			...
			hoverColor = Charts.Color(upColor).brighten(0.1).get(),
